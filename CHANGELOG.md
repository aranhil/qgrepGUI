...
### Version 2.14 (16/11/2025)

* Crash reports should now include filename and line number after including symbols in vsix package
* Addressed all reported crashes
* Fixed "Copy all results"
* Search file dialog now keeps its state after closing it
