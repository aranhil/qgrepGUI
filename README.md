...
- [Extended WPF Toolkit™](https://github.com/xceedsoftware/wpftoolkit): This project has been used for the color picker and the CheckComboBox. It is licensed under the [MS-PL license](./LICENSE-Extended-WPF-Toolkit.md).
