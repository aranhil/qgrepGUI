...
namespace qgrepSearch
{
    ...
    internal sealed class OpenSearchFiles
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenSearchFiles"/> class.
        ...
        {
            // Switch to the main thread - the call to AddCommand in OpenSearchFiles's constructor requires
            // the UI thread.
