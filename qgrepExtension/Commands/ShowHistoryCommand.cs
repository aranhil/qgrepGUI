...
namespace qgrepSearch
{
    ...
    internal sealed class ShowHistoryCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowHistoryCommand"/> class.
        ...
        /// </summary>
        public static ShowHistoryCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in ShowHistoryCommand's constructor requires
            // the UI thread.
