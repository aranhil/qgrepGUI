...
namespace qgrepSearch
{
    ...
    internal sealed class IncludeFilesCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IncludeFilesCommand"/> class.
        ...
        {
            // Switch to the main thread - the call to AddCommand in IncludeFilesCommand's constructor requires
            // the UI thread.
